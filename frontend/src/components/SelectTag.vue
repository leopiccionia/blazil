...
<template>
	<div class="autocomplete" ref="wrapper">
		<input class="form-field" type="text" aria-label="Pesquisar tag" v-model="search" @input="openDropdown" @keydown.down="moveDown" @keydown.enter.prevent="selectOption" @keydown.up="moveUp">
		<ul v-show="isOpen">
